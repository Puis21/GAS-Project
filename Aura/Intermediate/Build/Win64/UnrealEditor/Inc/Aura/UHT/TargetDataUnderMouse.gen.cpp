...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UDelegateFunction_Aura_MouseTargetDataSignature__DelegateSignature_Statics::NewProp_DataHandle = { "DataHandle", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(_Script_Aura_eventMouseTargetDataSignature_Parms, DataHandle), Z_Construct_UScriptStruct_FGameplayAbilityTargetDataHandle, METADATA_PARAMS(Z_Construct_UDelegateFunction_Aura_MouseTargetDataSignature__DelegateSignature_Statics::NewProp_DataHandle_MetaData, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_Aura_MouseTargetDataSignature__DelegateSignature_Statics::NewProp_DataHandle_MetaData)) }; // 3993235140
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_Aura_MouseTargetDataSignature__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_Aura, nullptr, "MouseTargetDataSignature__DelegateSignature", nullptr, nullptr, sizeof(Z_Construct_UDelegateFunction_Aura_MouseTargetDataSignature__DelegateSignature_Statics::_Script_Aura_eventMouseTargetDataSignature_Parms), Z_Construct_UDelegateFunction_Aura_MouseTargetDataSignature__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_Aura_MouseTargetDataSignature__DelegateSignature_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(Z_Construct_UDelegateFunction_Aura_MouseTargetDataSignature__DelegateSignature_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_Aura_MouseTargetDataSignature__DelegateSignature_Statics::Function_MetaDataParams)) };
...
void FMouseTargetDataSignature_DelegateWrapper(const FMulticastScriptDelegate& MouseTargetDataSignature, FGameplayAbilityTargetDataHandle const& DataHandle)
{
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UTargetDataUnderMouse_CreateTargetDataUnderMouse_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UTargetDataUnderMouse, nullptr, "CreateTargetDataUnderMouse", nullptr, nullptr, sizeof(Z_Construct_UFunction_UTargetDataUnderMouse_CreateTargetDataUnderMouse_Statics::TargetDataUnderMouse_eventCreateTargetDataUnderMouse_Parms), Z_Construct_UFunction_UTargetDataUnderMouse_CreateTargetDataUnderMouse_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UTargetDataUnderMouse_CreateTargetDataUnderMouse_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UTargetDataUnderMouse_CreateTargetDataUnderMouse_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UTargetDataUnderMouse_CreateTargetDataUnderMouse_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UTargetDataUnderMouse_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UTargetDataUnderMouse_CreateTargetDataUnderMouse, "CreateTargetDataUnderMouse" }, // 2243733158
	};
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UTargetDataUnderMouse_Statics::NewProp_ValidData = { "ValidData", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UTargetDataUnderMouse, ValidData), Z_Construct_UDelegateFunction_Aura_MouseTargetDataSignature__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_UTargetDataUnderMouse_Statics::NewProp_ValidData_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UTargetDataUnderMouse_Statics::NewProp_ValidData_MetaData)) }; // 1631407918
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UTargetDataUnderMouse_Statics::ClassParams = {
		...
		0,
		0x009000A4u,
		METADATA_PARAMS(Z_Construct_UClass_UTargetDataUnderMouse_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UTargetDataUnderMouse_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_Users_GenTl_OneDrive_Documents_GitHub_Aura_GAS_Project_Aura_Source_Aura_Public_AbilitySystem_AbilityTasks_TargetDataUnderMouse_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_GenTl_OneDrive_Documents_GitHub_Aura_GAS_Project_Aura_Source_Aura_Public_AbilitySystem_AbilityTasks_TargetDataUnderMouse_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTargetDataUnderMouse, UTargetDataUnderMouse::StaticClass, TEXT("UTargetDataUnderMouse"), &Z_Registration_Info_UClass_UTargetDataUnderMouse, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTargetDataUnderMouse), 2364583263U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_GenTl_OneDrive_Documents_GitHub_Aura_GAS_Project_Aura_Source_Aura_Public_AbilitySystem_AbilityTasks_TargetDataUnderMouse_h_3638036437(TEXT("/Script/Aura"),
		Z_CompiledInDeferFile_FID_Users_GenTl_OneDrive_Documents_GitHub_Aura_GAS_Project_Aura_Source_Aura_Public_AbilitySystem_AbilityTasks_TargetDataUnderMouse_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_GenTl_OneDrive_Documents_GitHub_Aura_GAS_Project_Aura_Source_Aura_Public_AbilitySystem_AbilityTasks_TargetDataUnderMouse_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
