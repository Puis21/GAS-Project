...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UDelegateFunction_Aura_AttributeInfoSignature__DelegateSignature_Statics::NewProp_Info = { "Info", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(_Script_Aura_eventAttributeInfoSignature_Parms, Info), Z_Construct_UScriptStruct_FGameAttributeInfo, METADATA_PARAMS(Z_Construct_UDelegateFunction_Aura_AttributeInfoSignature__DelegateSignature_Statics::NewProp_Info_MetaData, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_Aura_AttributeInfoSignature__DelegateSignature_Statics::NewProp_Info_MetaData)) }; // 3004416095
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_Aura_AttributeInfoSignature__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_Aura, nullptr, "AttributeInfoSignature__DelegateSignature", nullptr, nullptr, sizeof(Z_Construct_UDelegateFunction_Aura_AttributeInfoSignature__DelegateSignature_Statics::_Script_Aura_eventAttributeInfoSignature_Parms), Z_Construct_UDelegateFunction_Aura_AttributeInfoSignature__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_Aura_AttributeInfoSignature__DelegateSignature_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(Z_Construct_UDelegateFunction_Aura_AttributeInfoSignature__DelegateSignature_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_Aura_AttributeInfoSignature__DelegateSignature_Statics::Function_MetaDataParams)) };
...
void FAttributeInfoSignature_DelegateWrapper(const FMulticastScriptDelegate& AttributeInfoSignature, FGameAttributeInfo const& Info)
{
	struct _Script_Aura_eventAttributeInfoSignature_Parms
	{
		FGameAttributeInfo Info;
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UAttributeMenuWidgetController_UpgradeAttribute_Statics::NewProp_AttributeTag = { "AttributeTag", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(AttributeMenuWidgetController_eventUpgradeAttribute_Parms, AttributeTag), Z_Construct_UScriptStruct_FGameplayTag, METADATA_PARAMS(Z_Construct_UFunction_UAttributeMenuWidgetController_UpgradeAttribute_Statics::NewProp_AttributeTag_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UAttributeMenuWidgetController_UpgradeAttribute_Statics::NewProp_AttributeTag_MetaData)) }; // 1225434376
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UAttributeMenuWidgetController_UpgradeAttribute_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UAttributeMenuWidgetController, nullptr, "UpgradeAttribute", nullptr, nullptr, sizeof(Z_Construct_UFunction_UAttributeMenuWidgetController_UpgradeAttribute_Statics::AttributeMenuWidgetController_eventUpgradeAttribute_Parms), Z_Construct_UFunction_UAttributeMenuWidgetController_UpgradeAttribute_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UAttributeMenuWidgetController_UpgradeAttribute_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04420401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UAttributeMenuWidgetController_UpgradeAttribute_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UAttributeMenuWidgetController_UpgradeAttribute_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAttributeMenuWidgetController_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAttributeMenuWidgetController_UpgradeAttribute, "UpgradeAttribute" }, // 707837890
	};
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UAttributeMenuWidgetController_Statics::NewProp_AttributePointsChangedDelegate = { "AttributePointsChangedDelegate", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UAttributeMenuWidgetController, AttributePointsChangedDelegate), Z_Construct_UDelegateFunction_Aura_OnPlayerStatChangedSignature__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_UAttributeMenuWidgetController_Statics::NewProp_AttributePointsChangedDelegate_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAttributeMenuWidgetController_Statics::NewProp_AttributePointsChangedDelegate_MetaData)) }; // 2090756031
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UAttributeMenuWidgetController_Statics::NewProp_AttributeInfo = { "AttributeInfo", nullptr, (EPropertyFlags)0x0024080000010001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UAttributeMenuWidgetController, AttributeInfo), Z_Construct_UClass_UAttributeInfo_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UAttributeMenuWidgetController_Statics::NewProp_AttributeInfo_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAttributeMenuWidgetController_Statics::NewProp_AttributeInfo_MetaData)) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAttributeMenuWidgetController_Statics::ClassParams = {
		...
		0,
		0x009000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UAttributeMenuWidgetController_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UAttributeMenuWidgetController_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_Users_GenTl_OneDrive_Documents_GitHub_Aura_GAS_Project_Aura_Source_Aura_Public_UI_WidgetController_AttributeMenuWidgetController_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_GenTl_OneDrive_Documents_GitHub_Aura_GAS_Project_Aura_Source_Aura_Public_UI_WidgetController_AttributeMenuWidgetController_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAttributeMenuWidgetController, UAttributeMenuWidgetController::StaticClass, TEXT("UAttributeMenuWidgetController"), &Z_Registration_Info_UClass_UAttributeMenuWidgetController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAttributeMenuWidgetController), 572203186U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_GenTl_OneDrive_Documents_GitHub_Aura_GAS_Project_Aura_Source_Aura_Public_UI_WidgetController_AttributeMenuWidgetController_h_2352079425(TEXT("/Script/Aura"),
		Z_CompiledInDeferFile_FID_Users_GenTl_OneDrive_Documents_GitHub_Aura_GAS_Project_Aura_Source_Aura_Public_UI_WidgetController_AttributeMenuWidgetController_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_GenTl_OneDrive_Documents_GitHub_Aura_GAS_Project_Aura_Source_Aura_Public_UI_WidgetController_AttributeMenuWidgetController_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
