	...
	FGameplayEffectCustomExecutionOutput& OutExecutionOutput) const
{
	...
	IGameCombatInterface* SourceCombatInterface = Cast<IGameCombatInterface>(SourceAvatar);
	IGameCombatInterface* TargetCombatInterface = Cast<IGameCombatInterface>(TargetAvatar);
